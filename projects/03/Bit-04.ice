{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "4cdfbdd9-109e-4406-87f2-a7b80d47b5e2",
        ...
        {
          "id": "a7a4b19b-5853-425f-9c3e-2672b0dfeffc",
          "type": "0eb2d95f069b4972e081d110a74240d1d49f61d5",
          "position": {
            "x": 808,
            "y": 192
          },
      ...
      "wires": [
        {
          "source": {
            "block": "a7a4b19b-5853-425f-9c3e-2672b0dfeffc",
        ...
        {
          "source": {
            "block": "4cdfbdd9-109e-4406-87f2-a7b80d47b5e2",
  ...
  "dependencies": {
    ...
    "0eb2d95f069b4972e081d110a74240d1d49f61d5": {
      "package": {
        "name": "Print-Truth-Table-2x1 CLONE",
        "version": "0.1-c1591628533789",
        "description": "Calculate the Truth table of a combinational circuit of two inputs and one output. It is printed in the console",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "dff951b9-aae8-4027-9fc5-5d982a988ddb",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "in",
            ...
            {
              "id": "0fbb21b5-6a9a-405c-b4a7-89d6e71ccf30",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "load",
            ...
            {
              "id": "b43d266b-b0b4-44e2-a944-7ec1dab425d8",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "yellow",
                "name": "clk"
            ...
            {
              "id": "51049ef5-473f-424d-a55a-9b1d43d13b33",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "yellow",
                "name": "clk"
            ...
            {
              "id": "77c8e736-b40e-4d72-9f80-01c182bafb64",
              "type": "basic.inputLabel",
              "data": {
            ...
            {
              "id": "8bac1cac-8255-410c-adbf-f0c14be433f0",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "out",
            ...
            {
              "id": "1fbd77ad-28fe-45f2-9c21-e1e8a9c45d5d",
              "type": "basic.inputLabel",
              "data": {
                "name": "in_r",
                "pins": [
            ...
            {
              "id": "b7488d06-176e-4ebf-adcf-4ba8195fb37d",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "in",
            ...
            {
              "id": "e1e03f3d-9cd3-4e0f-9ccc-b1059ede2320",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "cap"
            ...
            {
              "id": "78a09f80-3825-4543-ba02-fa5620d06e27",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "cap"
            ...
            {
              "id": "4e024f16-6f48-4187-8356-3b8e014caf5f",
              "type": "basic.memory",
              "data": {
                "name": "mem",
                "list": "// in load time\n00  // 0+  \n00  // 1   \n01  // 1+  \n01  // 2   \n10  // 2+  \n10  // 3   \n11  // 3+  \n11  // 4   \n00  // 4+  \n00  // 5   \n10  // 5+  \n10  // 6   \n01  // 6+  \n01  // 7   \n11  // 7+  \n11  // 8   \n00  // 8+  \n00  // 9   \n00  // 9+  \n00  // 10  \n00  // 10+ \n00  // 11  \n00  // 11+ \n00  // 12  \n00  // 12+ \n00  // 13  \n00  // 13+ \n00  // 14  \n00  // 14+ \n00  // 15  \n00  // 15+ \n00  // 16  \n00  // 16+ \n00  // 17  \n00  // 17+ \n00  // 18  \n00  // 18+ \n00  // 19  \n00  // 19+ \n00  // 20  \n00  // 20+ \n00  // 21  \n00  // 21+ \n00  // 22  \n00  // 22+ \n00  // 23  \n00  // 23+ \n00  // 24  \n00  // 24+ \n00  // 25  \n00  // 25+ \n00  // 26  \n00  // 26+ \n00  // 27  \n00  // 27+ \n00  // 28  \n00  // 28+ \n00  // 29  \n00  // 29+ \n00  // 30  \n00  // 30+ \n00  // 31  \n00  // 31+ \n00  // 32  \n00  // 32+ \n00  // 33  \n00  // 33+ \n00  // 34  \n00  // 34+ \n00  // 35  \n00  // 35+ \n00  // 36  \n00  // 36+ \n00  // 37  \n00  // 37+ \n00  // 38  \n00  // 38+ \n00  // 39  \n00  // 39+ \n00  // 40  \n00  // 40+ \n00  // 41  \n00  // 41+ \n00  // 42  \n00  // 42+ \n00  // 43  \n00  // 43+ \n00  // 44  \n00  // 44+ \n00  // 45  \n00  // 45+ \n00  // 46  \n00  // 46+ \n00  // 47  \n00  // 47+ \n00  // 48  \n00  // 48+ \n00  // 49  \n00  // 49+ \n00  // 50  \n00  // 50+ \n00  // 51  \n00  // 51+ \n00  // 52  \n00  // 52+ \n00  // 53  \n00  // 53+ \n00  // 54  \n00  // 54+ \n00  // 55  \n00  // 55+ \n00  // 56  \n00  // 56+ \n00  // 57  \n01  // 57+ \n01  // 58  \n10  // 58+ \n10  // 59  \n10  // 59+ \n10  // 60  \n10  // 60+ \n10  // 61  \n10  // 61+ \n10  // 62  \n10  // 62+ \n10  // 63  \n10  // 63+ \n10  // 64  \n10  // 64+ \n10  // 65  \n10  // 65+ \n10  // 66  \n10  // 66+ \n10  // 67  \n10  // 67+ \n10  // 68  \n10  // 68+ \n10  // 69  \n10  // 69+ \n10  // 70  \n10  // 70+ \n10  // 71  \n10  // 71+ \n10  // 72  \n10  // 72+ \n10  // 73  \n10  // 73+ \n10  // 74  \n10  // 74+ \n10  // 75  \n10  // 75+ \n10  // 76  \n10  // 76+ \n10  // 77  \n10  // 77+ \n10  // 78  \n10  // 78+ \n10  // 79  \n10  // 79+ \n10  // 80  \n10  // 80+ \n10  // 81  \n10  // 81+ \n10  // 82  \n10  // 82+ \n10  // 83  \n10  // 83+ \n10  // 84  \n10  // 84+ \n10  // 85  \n10  // 85+ \n10  // 86  \n10  // 86+ \n10  // 87  \n10  // 87+ \n10  // 88  \n10  // 88+ \n10  // 89  \n10  // 89+ \n10  // 90  \n10  // 90+ \n10  // 91  \n10  // 91+ \n10  // 92  \n10  // 92+ \n10  // 93  \n10  // 93+ \n10  // 94  \n10  // 94+ \n10  // 95  \n10  // 95+ \n10  // 96  \n10  // 96+ \n10  // 97  \n10  // 97+ \n10  // 98  \n10  // 98+ \n10  // 99  \n10  // 99+ \n10  // 100 \n10  // 100+\n10  // 101 \n10  // 101+\n10  // 102 \n10  // 102+\n10  // 103 \n10  // 103+\n10  // 104 \n10  // 104+\n10  // 105 \n10  // 105+\n10  // 106 \n10  // 106+\n10  // 107 ",
            ...
            {
              "id": "4d5bab49-8e5f-4de9-b491-31e5ad0014cd",
              "type": "7967bf37830e8d86ed54144b30edda1ac2146b10",
              "position": {
                "x": 1080,
                "y": 560
            ...
            {
              "id": "644776d1-2639-4453-81d4-f88fa8862e3f",
            ...
            {
              "id": "caa51881-3a99-440c-a38b-6a566882c8b4",
              "type": "98e5ae2f9f3847b149c09040eedd2d30cc28ccee",
              "position": {
                "x": 688,
                "y": 1184
              },
            ...
            {
              "id": "3c5d2850-047b-47ef-bf1e-a9ddf0129c05",
            ...
            {
              "id": "0164ab72-2b80-4f57-a6f7-381f5ad7f53d",
              "type": "42ebf732ed72b2aa979e6858281bfe62c10bec5f",
              "position": {
                "x": 48,
                "y": 1504
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "4d5bab49-8e5f-4de9-b491-31e5ad0014cd",
                "port": "04841e3c-8761-454a-8d99-496fde26ea1f"
              }
            },
            {
            ...
            {
              "source": {
                "block": "644776d1-2639-4453-81d4-f88fa8862e3f",
                "port": "0f7487e5-b070-4277-bba6-acf69934afca"
              },
              "target": {
                "block": "0fbb21b5-6a9a-405c-b4a7-89d6e71ccf30",
                "port": "inlabel"
              },
              "vertices": []
            },
            {
              ...
              "target": {
                "block": "dff951b9-aae8-4027-9fc5-5d982a988ddb",
                "port": "inlabel"
              },
              "vertices": []
            },
            {
              "source": {
                "block": "3c5d2850-047b-47ef-bf1e-a9ddf0129c05",
                "port": "aa84d31e-cd92-44c7-bb38-c7a4cd903a78"
              },
              "target": {
                "block": "1fbd77ad-28fe-45f2-9c21-e1e8a9c45d5d",
                "port": "inlabel"
              },
              "vertices": []
            },
            {
              "source": {
                "block": "78a09f80-3825-4543-ba02-fa5620d06e27",
                "port": "outlabel"
              },
              "target": {
                "block": "3c5d2850-047b-47ef-bf1e-a9ddf0129c05",
            ...
            {
              "source": {
                "block": "51049ef5-473f-424d-a55a-9b1d43d13b33",
                "port": "outlabel"
              },
              "target": {
                "block": "3c5d2850-047b-47ef-bf1e-a9ddf0129c05",
            ...
            {
              "source": {
                "block": "b7488d06-176e-4ebf-adcf-4ba8195fb37d",
                "port": "outlabel"
              },
              "target": {
                "block": "3c5d2850-047b-47ef-bf1e-a9ddf0129c05",
            ...
            {
              "source": {
                "block": "0164ab72-2b80-4f57-a6f7-381f5ad7f53d",
                "port": "aa84d31e-cd92-44c7-bb38-c7a4cd903a78"
              },
              "target": {
                "block": "77c8e736-b40e-4d72-9f80-01c182bafb64",
                "port": "inlabel"
              },
              "vertices": []
            },
            {
              "source": {
                "block": "e1e03f3d-9cd3-4e0f-9ccc-b1059ede2320",
                "port": "outlabel"
              },
              "target": {
                "block": "0164ab72-2b80-4f57-a6f7-381f5ad7f53d",
            ...
            {
              "source": {
                "block": "b43d266b-b0b4-44e2-a944-7ec1dab425d8",
                "port": "outlabel"
              },
              "target": {
                "block": "0164ab72-2b80-4f57-a6f7-381f5ad7f53d",
            ...
            {
              "source": {
                "block": "8bac1cac-8255-410c-adbf-f0c14be433f0",
                "port": "outlabel"
              },
              "target": {
                "block": "0164ab72-2b80-4f57-a6f7-381f5ad7f53d",
            ...
            {
              "source": {
                "block": "caa51881-3a99-440c-a38b-6a566882c8b4",
            ...
            {
              "source": {
                "block": "4e024f16-6f48-4187-8356-3b8e014caf5f",
                "port": "memory-out"
              },
              "target": {
                "block": "caa51881-3a99-440c-a38b-6a566882c8b4",
    ...
    "98e5ae2f9f3847b149c09040eedd2d30cc28ccee": {
      "package": {
        "name": "mi-tabla8-2",
        "version": "0.1",
        "description": "Circuito combinacional de 8 entradas y 2 salidas",
